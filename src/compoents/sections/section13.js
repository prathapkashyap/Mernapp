...
export default class Section13 extends Component {
    ...
    checked=(e)=>{
      ...
      handleSubmit=(e)=>{
        ...
        axios.post('/api/section13',{section13:this.state}).then((res)=>{
          console.log(res)
        })
        }
    render() {
    ...
    return (
      ...
      <div style={{margin:"50px",paddingBottom:40}} >
        <div>
            <textarea style={{fontSize:40,padding:"60px"}}   className="materialize-textarea " defaultValue="Stock"></textarea>
                <textarea onChange={this.handleChange} className="materialize-textarea" placeholder="Description(optional)" id="stock"/>
        </div>
        <div>
        <div >
            <span>Is Stock Registration received(other records if no)?</span>
            <br/>
            <br/>
        ...
        <div>
            <br/>
            <span>Is there any sold goods in stock?</span>
            <br/>
            <br/>
            <label style={{paddingLeft:"80px",paddingRight:"80px"}} >
            ...
            <br/>
            <span>Is there any sold goods in stock but which are not taken in sales ?</span>
            <br/>
            <br/>
            <label style={{paddingLeft:"80px",paddingRight:"80px"}}>
